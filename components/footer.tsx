...
const footer = () => {
  return (
    <footer className="bg-gray-900">
        ...
        <div className="grid md:grid-cols-3 gap-7">
          <div>
            ...
            <p className="text-gray-400">
              ...
              libero saepe voluptatum quia sint dolor?
            </p>
          </div>
          ...
          <div>
            ...
            <form action="" className="mt-5">
              ...
              <button className="bg-orange-400 p-3 font-bold text-white text-center rounded-sm hover:bg-orange-500">
                subscribe
              </button>
            </form>
          </div>
      ...
      <div className="max-w-screen-xl-mx-auto px-4 mt-8 border-t border-gray-500 py-4 text-center text-base text-gray-50">
        &copy; 2024 Booking Apps Mengayu. All rights reserved.
      </div>
    </footer>
  );
};
